...
* Add an integration test that loads a large number (100K+) of encrypted strings in to the database, queues a rotation job and then polls it until the job is complete
